...
export class MemoryPathResolver {
  ...
  private resolveProjectSlug(): { slug: string | null; method: string; diagnostics: string } {
  ...
  private slugify(absolutePath: string): string {
