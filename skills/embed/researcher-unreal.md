...
4. `seed/skills/embed/researcher-unreal.md`
...
Deliverable: Unreal 引擎主线调查报告（SendMessage 给 leader 与 builder-unreal）
Done Definition: 报告按 researcher-common 的三段格式输出；仅覆盖 Unreal 主线方向；如运行时必查项缺失，则按 researcher-runtime-common 输出必查项缺失错误
Dependencies: none
Risk Level: low
